...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/building_3-shadow.png
  AssetGenImage get building3Shadow =>
      const AssetGenImage('assets/images/building_3-shadow.png');
  ...
  AssetGenImage get bush1Shadow =>
      const AssetGenImage('assets/images/bush_1-shadow.png');

  /// File path: assets/images/bush_1.png
  AssetGenImage get bush1 => const AssetGenImage('assets/images/bush_1.png');

  /// File path: assets/images/bush_2-shadow.png
  AssetGenImage get bush2Shadow =>
      const AssetGenImage('assets/images/bush_2-shadow.png');
  ...
  /// File path: assets/images/paper_background_rect_thin.png
  AssetGenImage get paperBackgroundRectThin =>
      const AssetGenImage('assets/images/paper_background_rect_thin.png');
  ...
  SvgGenImage get starEmpty =>
      const SvgGenImage('assets/images/star_empty.svg');
